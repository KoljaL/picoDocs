...
//////////////////////////////////////////////////////////////////////////////
// // code comments are no headings
// // https://github.com/BenjaminHoegh/ParsedownExtended/issues/17
// // var for code case
// $is_code = false;
// foreach ($lines as $headerLine) {
//   // if code detected (line strats with "``") toggle code var
//   if (substr(trim($headerLine),0,2) == '``'  || (substr(trim($headerLine),0,2) == '``' && substr(trim($headerLine),-2) == '``'  ))
//   {
//     $is_code = !$is_code;
//   }
...
//     $prevLine = $headerLine;
//
//     // //      echo substr(trim($headerLine),-6)."XX<br>";
//     // // // if code detected (line strats with "``") toggle code var
//     // if (substr(trim($headerLine),-2) == '``')
//     // {
//     // //  echo "ende";
//     // echo substr(trim($headerLine),-6)."XX<br>";
//     //   $is_code = 0;
